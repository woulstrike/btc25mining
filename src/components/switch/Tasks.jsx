...
import { MainSrcButton, ChannelSrcButton, GalxeSrcButton, TwitterSrcButton, TonkeeperSrcButton, StonFiSrcButton } from '../button/tasksButtonSection';
      ...
      <div className="page">
        ...
        <div className="task-container">
          ...
          <div className="task-container">
            ...
            <span className="text">
            Visit STON.fi and get coins<br />
              <span className="quantity" style={{ color: '#00FFE0' }}>+1.000</span>
            </span>
            <div className="reward-button-container">
              <a href="https://app.ston.fi/swap?chartVisible=true&ft=TON&tt=EQC7rnHHtMVBKyhiGnAbtYIlzGxS0dfi3ZbHExFX0LYi9cAH&chartInterval=1w" target="_blank" rel="noopener noreferrer">
                <StonFiSrcButton />
              </a>
            </div>
          </div>
